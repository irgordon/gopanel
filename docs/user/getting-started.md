...
GoPanel currently supports local sign-in, server registration, and administrator diagnostics. Docker and other managed-system operations are not available until later phases.
